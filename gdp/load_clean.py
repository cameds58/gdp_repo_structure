...
def load_gdp_by_country(country: str) -> pd.DataFrame:
    """
    Load gdp by country via EODHD API.
    Free tier user and can only query 20 times a day.
    Parameters:
    ...
    """
    base_url = 'https://eodhd.com/api/macro-indicator/'
    params = f'{country}?indicator=gdp_current_usd'
    api = '&api_token=65549defed6b89.08154842&fmt=csv'
...
def clean_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # assuming the year columns exist as actual years
